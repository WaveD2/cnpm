...
import NotificationBell from "../components/helper/notif";
...
export default function Nav() {
  ...
  const navClass =
    "text-gray-700 hover:text-purple-600 transition-colors duration-300 font-medium";
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center px-4 py-2">
                      <img
                        src={
                          user?.avatar ||
                          "https://images.pexels.com/photos/13288544/pexels-photo-13288544.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                        }
                        alt="User Avatar"
