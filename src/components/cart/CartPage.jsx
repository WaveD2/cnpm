      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {cart && cart.items && cart.items.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <AnimatePresence>
                {cart.items.map((item) => (
                  <motion.div
                    ...
                    className="flex items-center bg-gray-100 rounded-lg p-4 mb-4 shadow-md hover:shadow-lg transition-shadow"
                  >
                    <img
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-blue-600 mt-2">
                        {item.productId.discountedPrice.toLocaleString("vi-VN")} VND
                      </p>
                    </div>
            ...
            >
              <h2 className="text-xl font-semibold mb-4 text-gray-900">Tổng kết đơn hàng</h2>
          ...
          >
            ...
            <p className="text-lg mt-4 text-gray-600">Giỏ hàng của bạn đang trống</p>
            <Link to="/store">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
